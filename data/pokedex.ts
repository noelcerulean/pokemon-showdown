export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	lunapede: {
		...
		name: "Lunapede",
		types: ["Bug", "Fairy"],
		baseStats: {hp: 94, atk: 98, def: 73, spa: 85, spd: 114, spe: 68},
		abilities: {0: "Inner Focus", 1: "Luminesce", H: "Pixilate"},
		heightm: 2.2,
		weightkg: 62,
		color: "Green",
	...
	furfrouprincess: {
		...
		color: "White",
		eggGroups: ["Undiscovered"],
		cosmeticFormes: ["Furfrou-Princess-Party", "Furfrou-Princess-Pomp", "Furfrou-Princess-Punk"],
		formeOrder: ["Furfrou-Princess", "Furfrou-Princess-Party", "Furfrou-Princess-Pomp", "Furfrou-Princess-Punk"],
	},
	espurr: {
		num: 677,
		name: "Espurr",
