export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	ekans: {
		...
		abilities: {0: "Intimidate", 1: "Shed Skin", H: "Enfeebling Venom"},
		heightm: 2,
		weightkg: 6.9,
		color: "Purple",
		evos: ["Arbok"],
	...
	koffing: {
		...
		name: "Koffing",
		types: ["Poison"],
		baseStats: {hp: 40, atk: 65, def: 105, spa: 75, spd: 55, spe: 35},
		abilities: {0: "Levitate", 1: "Neutralizing Gas", H: "Flare Boost"},
		heightm: 0.6,
		weightkg: 1,
		color: "Purple",
	...
	qwilfish: {
		...
		abilities: {0: "Inflate", 1: "Swift Swim", H: "Intimidate"},
		heightm: 0.5,
		weightkg: 3.9,
		color: "Gray",
		eggGroups: ["Water 2"],
	...
	zangoose: {
		...
		abilities: {0: "Immunity", 1: "Reckless", H: "Toxic Boost"},
		heightm: 1.3,
		weightkg: 40.3,
		color: "White",
		eggGroups: ["Field"],
	...
	shieldondelta: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 50, atk: 52, def: 118, spa: 52, spd: 108, spe: 30},
		abilities: {0: "Corrosion", 1: "Cursed Body", H: "Liquid Ooze"},
		heightm: 0.5,
		weightkg: 37,
		color: "Gray",
	...
	vanilluxefnf: {
		...
		types: ["Ice", "Poison"],
		baseStats: {hp: 71, atk: 95, def: 85, spa: 135, spd: 95, spe: 79},
		abilities: {0: "Ice Body", 1: "Noxious Emission", H: "Chemical Bath"},
		heightm: 1.3,
		weightkg: 57.5,
		color: "White",
		prevo: "Vanillish",
