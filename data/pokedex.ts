export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	kricketot: {
		...
		name: "Kricketot",
		types: ["Bug"],
		baseStats: {hp: 47, atk: 35, def: 51, spa: 87, spd: 66, spe: 25},
	...
	swadloon: {
		...
		abilities: {0: "Triage", 1: "Leaf Guard", H: "Sunbathing"},
		heightm: 0.5,
		weightkg: 7.3,
		color: "Green",
		prevo: "Sewaddle",
	...
	maractus: {
		...
		color: "Green",
		eggGroups: ["Grass"],
		cosmeticFormes: ["Maractus-Bald"],
		formeOrder: ["Maractus", "Maractus-Bald"],
	},
	dwebble: {
		num: 557,
		name: "Dwebble",
