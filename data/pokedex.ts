export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	teddiursa: {
		...
		evos: ["Ursaring"],
		eggGroups: ["Field"],
		otherFormes: ["Teddiursa-Shadow"],
		formeOrder: ["Teddiursa", "Teddiursa-Shadow"],
	},
	teddiursashadow: {
		num: 216,
		name: "Teddiursa-Shadow",
		baseSpecies: "Teddiursa",
		forme: "Shadow",
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 60, atk: 90, def: 50, spa: 50, spd: 50, spe: 40},
		abilities: {0: "Pickup", 1: "Quick Feet", H: "Beast Boost"},
		heightm: 0.6,
		weightkg: 8.8,
		color: "Brown",
		eggGroups: ["Undiscovered"],
