export const MovesText: {[k: string]: MoveText} = {
	...
	aggregate: {
		...
		shortDesc: "If hazards on user side, clears/heals 50% HP.",

		activate: "  [POKEMON] consumed the hazards around it!",
	},
	agility: {
		name: "Agility",
	...
	berserkterrain: {
		...
		desc: "For 5 turns, the terrain becomes Bersek Terrain. During the effect, the power of Fairy-type attacks used against grounded Pokemon is multiplied by 0.5 and grounded Pokemon are protected from secondary effects of moves. Grounded Pokemon will also not become locked when using Outrage, Petal Dance, Ravagement, Shadow Frenzy, or Thrash. Camouflage transforms the user into a Dragon type, Nature Power becomes Dragon Pulse, and Secret Power has a 30% chance to lower Defense by 1 stage. Fails if the current terrain is Berserk Terrain.",
		shortDesc: "5 turns. No secondaries, -Fairy power vs grounded.",
		gen6: {
			desc: "For 5 turns, the terrain becomes Berserk Terrain. During the effect, the power of Fairy-type attacks used against grounded Pokemon is multiplied by 0.5 and grounded Pokemon are protected from secondary effects of moves. Grounded Pokemon will also not become locked when using Outrage, Petal Dance, Ravagement, Shadow Frenzy, or Thrash. Camouflage transforms the user into a Dragon type, Nature Power becomes Dragon Pulse, and Secret Power has a 30% chance to lower Defense by 1 stage. Fails if the current terrain is Berserk Terrain.",
		},
	},
	bestow: {
		name: "Bestow",
	...
	camouflage: {
		...
		gen6: {
			desc: "The user's type changes based on the battle terrain. Normal type on the regular Wi-Fi terrain, Electric type during Electric Terrain, Fairy type during Misty Terrain, Dragon type during Berserk Terrain, and Grass type during Grassy Terrain. Fails if the user's type cannot be changed or if the user is already purely that type.",
		},
		gen5: {
	...
	darkpulse: {
		...
		shortDesc: "10% chance to lower target's Sp. Atk by 1.",
	},
	darkvoid: {
		name: "Dark Void",
	...
	defog: {
		name: "Defog",
		desc: "Lowers the target's evasiveness by 1 stage. If this move is successful and whether or not the target's evasiveness was affected, the effects of Reflect, Light Screen, Aurora Veil, Safeguard, Mist, Spikes, Toxic Spikes, Stealth Rock, and Sticky Web end for the target's side, and the effects of Spikes, Toxic Spikes, Stealth Rock, and Sticky Web end for the user's side. Ignores a target's substitute, although a substitute will still block the lowering of evasiveness. If there is a terrain or diffusion active and this move is successful, the terrain and/or diffusion will be cleared.",
		shortDesc: "-1 evasion; clears terrain and hazards on both sides.",
		gen7: {
			desc: "Lowers the target's evasiveness by 1 stage. If this move is successful and whether or not the target's evasiveness was affected, the effects of Reflect, Light Screen, Aurora Veil, Safeguard, Mist, Spikes, Toxic Spikes, Stealth Rock, and Sticky Web end for the target's side, and the effects of Spikes, Toxic Spikes, Stealth Rock, and Sticky Web end for the user's side. Ignores a target's substitute, although a substitute will still block the lowering of evasiveness. If there is a diffusion active and this move is successful, the diffusion will be cleared.",
			shortDesc: "-1 evasion; clears diffusion & hazards on both sides.",
		},
		gen6: {
	...
	hiddenpower: {
		name: "Hidden Power",
		desc: "This move's type depends on the user's individual values (IVs), and can be any type but Fairy and Normal. Its power is boosted by 1.5x when used by Allnown.",
		shortDesc: "User IVs vary type. Allnown: 1.5x power.",
		gen5: {
	...
	miasma: {
		name: "Miasma",
		desc: "For 5 turns, the weather becomes Miasma. Lasts for 8 turns if the user is holding Mordant Rock. Fails if the current weather is Miasma.",
	...
	mindwipe: {
		name: "Mind Wipe",
		desc: "Deals damage to the target based on target's Defense or Sp. Defense, whichever stat is lower. After successfully hitting the foe, target's boosts and ability will be removed. This move cannot be used twice in a row.",
		shortDesc: "Can't use 2x. Hits lower def, clears abil/boosts.",
	...
	naturepower: {
		...
		gen6: {
			desc: "This move calls another move for use based on the battle terrain. Tri Attack on the regular Wi-Fi terrain, Thunderbolt during Electric Terrain, Moonblast during Misty Terrain, Dragon Pulse during Berserk Terrain, and Energy Ball during Grassy Terrain.",
		},
		gen5: {
	...
	present: {
		name: "Present",
		desc: "If this move is successful, it deals damage or heals the target. 35% chance for 65 power, 25% chance for 80 power, 15% chance for 120 power, 5% chance for 120 power + Ice Typing, 3% chance for 250 power and self destructing, 15% chance to heal the target by 1/4 of its maximum HP, rounded down, and 2% chance to fully heal the target's HP.",
		shortDesc: "Unpredictable. May harm or heal the opponent.",
		gen2: {
	...
	roleplay: {
		name: "Role Play",
		desc: "The user's Ability changes to match the target's Ability. Fails if the user's Ability is As One, Battle Bond, Comatose, Disguise, Gulp Missile, Ice Face, Multitype, Power Construct, RKS System, Schooling, Shields Down, Stance Change, Zen Mode, or already matches the target, or if the target's Ability is As One, Battle Bond, Comatose, Disguise, Flower Gift, Forecast, Gulp Missile, Hunger Switch, Ice Face, Illusion, Imposter, Multitype, Neutralizing Gas, Power Construct, Power of Alchemy, RKS System, Schooling, Shields Down, Stance Change, Trace, Wonder Guard, or Zen Mode.",
		shortDesc: "User replaces its Ability with the target's.",
		gen7: {
			desc: "The user's Ability changes to match the target's Ability. Fails if the user's Ability is Battle Bond, Comatose, Disguise, Multitype, Power Construct, RKS System, Schooling, Shields Down, Stance Change, Zen Mode, or already matches the target, or if the target's Ability is Battle Bond, Comatose, Disguise, Flower Gift, Forecast, Illusion, Imposter, Multitype, Power Construct, Power of Alchemy, RKS System, Schooling, Shields Down, Stance Change, Trace, Wonder Guard, or Zen Mode.",
		},
		gen6: {
	...
	shadowevoboost: {
		...
		shortDesc: "User +2 to main stats. Unusable twice in a row.",
	},
	shadowfire: {
		name: "Shadow Fire",
	...
	shadowfrenzy: {
		name: "Shadow Frenzy",
		desc: "The user spends two or three turns locked into this move and becomes confused immediately after its move on the last turn of the effect if it is not already. This move targets an opposing Pokemon at random on each turn. If the user is prevented from moving, is asleep at the beginning of a turn, or the attack is not successful against the target on the first turn of the effect or the second turn of a three-turn effect, the effect ends without causing confusion. If this move is called by Sleep Talk and the user is asleep, the move is used for one turn and does not confuse the user. This move does not lock in Berserk Terrain.",
		shortDesc: "Crits. Lasts 2-3 turns. Confuses the user afterwards.",
	},
	shadowforce: {
		name: "Shadow Force",
		desc: "If this move is successful, it breaks through the target's Baneful Bunker, Detect, King's Shield, Protect, or Spiky Shield for this turn, allowing other Pokemon to attack the target normally. If the target's side is protected by Crafty Shield, Mat Block, Quick Guard, or Wide Guard, that protection is also broken for this turn and other Pokemon may attack the target's side normally. This attack charges on the first turn and executes on the second. On the first turn, the user avoids all attacks. If used in Evanesce Diffusion or if user is holding a Power Herb, the move completes in one turn.",
	...
	shadowpunish: {
		name: "Shadow Punish",
		desc: "Always crits. Power is equal to 55+(X*30), where X is the target's total stat stage changes that are greater than 0.",
	...
	vendetta: {
		name: "Vendetta",
		desc: "+1 priority if one of the user's party members fainted last turn.",
		shortDesc: "+1 priority if an ally fainted last turn.",
	},
	venomdrench: {
		name: "Venom Drench",
