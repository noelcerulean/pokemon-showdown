export const DefaultText: {[k: string]: DefaultText} = {
	...
	frz: {
		start: "  [POKEMON] was frozen and developed frostbite!",
	...
	par: {
		start: "  [POKEMON] is paralyzed! Moving may hurt it!",
		...
		endFromMove: "  [POKEMON]'s [MOVE] healed its paralysis!",
		damage: "[POKEMON] is hurt by paralysis!",
	},
	psn: {
	...
	// diffusion
	evanescediffusion: {
		start: "  The tangibility of Pokemon is warping!",
