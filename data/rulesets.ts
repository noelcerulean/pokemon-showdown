...
export const Rulesets: {[k: string]: FormatData} = {
	...
	storydoubles: {
		...
		ruleset: [
			'Obtainable', 'Nickname Clause', 'OHKO Clause', 'Evasion Moves Clause', 'Gravity Sleep Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod',
		],
	},
	standardnatdex: {
		effectType: 'ValidatorRule',
	...
	cfzclause: {
		...
		banlist: [
			...
			'Rapid Raidswipe', 'Melancholia Expanse', 'Fervid Feverdream', 'Pheromonic Phantasmagoria', 'Genesis of Eternal Growth',
		],
		onBegin() {
