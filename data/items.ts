export const Items: {[itemid: string]: ItemData} = {
	...
	bigroot: {
		...
		onTryHeal(damage, target, source, effect) {
			const heals = ['drain', 'leechseed', 'ingrain', 'aquaring', 'strengthsap', 'parasiticdrain', 'shadowfountain'];
	...
	bluiniumz: {
		...
		itemUser: ["Blastoise", "Venustoise", "Feraligatr", "Swampert", "Empoleon", "Samurott", "Samurott-Knight", "Greninja", "Greninja-Ash", "Primarina", "Primarina-Pride", "Primarina-Safiya", "Primarina-Soprano", "Inteleon"],
		num: -580,
		gen: 7,
		isNonstandard: "Past",
	},
	...
	decidiumz: {
		...
		itemUser: ["Decidueye", "Decidueye-Apollo", "Decidueye-Apollo-Toga", "Decidueye-Apollo-Pride"],
		num: 798,
		gen: 7,
		isNonstandard: "Past",
	},
	...
	fragrantherb: {
		...
		onTakeItem(item, pokemon, source) {
			if ((source && source.baseSpecies.num === 154) || pokemon.baseSpecies.num === 154) {
				return false;
			}
			return true;
		},
	...
	greeniumz: {
		...
		itemUser: ["Venusaur", "Venusaur-Sylvanos", "Venustoise", "Meganium", "Meganium-Aniseed", "Sceptile", "Sceptile-Moscho", "Torterra", "Serperior", "Chesnaught", "Decidueye", "Decidueye-Apollo", "Decidueye-Apollo-Toga", "Decidueye-Apollo-Pride", "Rillaboom"],
		num: -582,
		gen: 7,
		isNonstandard: "Past",
	},
	...
	inciniumz: {
		...
		itemUser: ["Incineroar", "Incineroar-Pride"],
		num: 799,
		gen: 7,
		isNonstandard: "Past",
	},
	...
	lifeorb: {
		...
		onAfterMoveSecondarySelf(source, target, move) {
			if (source && source !== target && move && move.category !== 'Status' && !(source.hasAbility('Magic Guard'))) {
	...
	marshadiumz: {
		...
		itemUser: ["Marshadow", "Marshadow-Mug"],
		num: 802,
		gen: 7,
		isNonstandard: "Past",
	},
		...
		onTryAddVolatile(status, target, source, effect) {
			...
			if (['attract', 'disable', 'encore', 'healblock', 'taunt', 'torment'].includes(status.id)) {
				...
				if (effect.effectType === 'Move') {
					...
					this.add('-block', target, 'ability: Battle Armor', '[of] ' + effectHolder);
				}
				return null;
			}
		},
	...
	primariumz: {
		...
		itemUser: ["Primarina", "Primarina-Pride", "Primarina-Safiya", "Primarina-Soprano"],
		num: 800,
		gen: 7,
		isNonstandard: "Past",
	},
	...
	rediniumz: {
		...
		itemUser: ["Charizard", "Typhlosion", "Typhlosion-Volc", "Typhlosion-Vesuvius", "Typhlosion-Vesuvius-Elden", "Blaziken", "Infernape", "Emboar", "Emboar-Dynamite", "Delphox", "Incineroar", "Incineroar-Pride", "Cinderace"],
		num: -581,
		gen: 7,
		isNonstandard: "Past",
	},
