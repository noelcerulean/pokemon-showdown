export const Items: {[itemid: string]: ItemData} = {
	...
	bluiniumz: {
		...
		itemUser: ["Blastoise", "Venustoise", "Feraligatr", "Swampert", "Swapert-Hero", "Empoleon", "Samurott", "Samurott-Knight", "Greninja", "Greninja-Ash", "Primarina", "Primarina-Pride", "Primarina-Safiya", "Primarina-Soprano", "Primarina-Peony", "Inteleon"],
		num: -580,
		gen: 7,
		isNonstandard: "Past",
	},
