export const FormatsData: {[k: string]: ModdedSpeciesFormatsData} = {
	...
	parasect: {
		randomBattleMoves: ["fungification", "leechlife", "parasiticplot", "protect", "spore"],
		randomDoubleBattleMoves: ["fungification", "leechlife", "parasiticplot", "protect", "ragepowder", "spore"],
		tier: "UU",
		doublesTier: "(DUU)",
	},
	venonat: {
	...
	sceptilemega: {
		randomBattleMoves: ["dragonpulse", "earthquake", "focusblast", "gigadrain", "hiddenpowerfire", "leafblade", "lightningkick", "outrage", "substitute", "swordsdance"],
