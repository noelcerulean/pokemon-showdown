...
export class RandomGen7Teams extends RandomTeams {
	...
	shouldCullAbility(
		...
		case 'Ice Body': case 'Innards Out': case 'Moody': case 'Steadfast':
			return true;
		case 'Aerilate': case 'Galvanize': case 'Pixilate': case 'Refrigerate': case 'Toxicate': case 'Malevolate': case 'Draconize':
		...
		case 'Sand Force': case 'Sand Rush': case 'Sedimentary': case 'Sand Veil':
	...
	randomSet(
		...
		if (!isDoubles) {
			...
			const customScale: {[k: string]: number} = {
				...
				// Holistic judgement
				'Castform-Rainy': 100, 'Castform-Snowy': 100, 'Castform-Sunny': 100, 'Castform-Sandy': 100, 'Castform-Smoggy': 100, 'Castform-Shady': 100, Delibird: 100, Spinda: 100, Unown: 100,
			};
		...
		for (const restrict of [true, false]) {
			...
			while (pokemonPool.length && pokemon.length < this.maxTeamSize) {
				...
				case 'Floette':
					...
					break;
				case 'Aegislash': case 'Cherrim': case 'Gourgeist': case 'Groudon': case 'Kyogre': case 'Meloetta':
