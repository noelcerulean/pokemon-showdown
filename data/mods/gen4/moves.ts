export const Moves: {[k: string]: ModdedMoveData} = {
	...
	moonlight: {
		...
		onHit(pokemon) {
			...
			} else if (this.field.isWeather(['raindance', 'primordialsea', 'sandstorm', 'hail', 'miasma'])) {
