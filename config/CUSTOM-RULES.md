...
`Gen 7 Camomons` - Pokémon will change their typing to match their first two moveslots

`Gen 7 Re-Evolution` - Pokémon will gain base stats equal to the difference with their previous stage
