		...
		for (const [i, newTarget] of newTargets.entries()) {
			...
			case 'move':
				...
				if (showDetails) {
					...
					if (move.flags['wind'] && dex.gen >= 7) details["&#10003; Wind move"] = "";
					if (move.flags['light'] && dex.gen >= 5) details["&#10003; Light move"] = "";
	...
	calc(target, room, user, connection, cmd) {
		...
		if (RANDOMS_CALC_COMMANDS.includes(cmd) ||
			...
			return this.sendReplyBox(
				...
				`- <a href="https://noobscrub27.github.io/fnf-damage-calc/dist/index.html">Random Battles Damage Calculator</a>`
			);
		}
		...
		this.sendReplyBox(
			...
			`- <a href="https://noobscrub27.github.io/fnf-damage-calc/dist/index.html">Damage Calculator</a>`
		);
	},
	calchelp: [
